    ...
    <div className="flex gap-4 flex-col">
      ...
      <Popover open={openCountryDropdown} onOpenChange={setOpenCountryDropdown}>
        ...
        <PopoverContent className="w-[300px] p-0">
          <Command>
            <CommandInput placeholder="Vyhledat zemi..." />
            <CommandList>
              <CommandEmpty>Žádná země nenalezena.</CommandEmpty>
              <CommandGroup>
      ...
      {availableStates.length > 0 && (
        <Popover open={openStateDropdown} onOpenChange={setOpenStateDropdown}>
          <PopoverTrigger asChild>
            ...
            >
              {selectedState ? (
                ...
                <span>Vyberte kraj nebo město...</span>
              )}
              <ChevronsUpDown className="h-4 w-4 shrink-0 opacity-50" />
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-[300px] p-0">
            <Command>
              <CommandInput placeholder="Vyhledej kraj nebo město..." />
              <CommandList>
                <CommandEmpty>Žádný kraj nebo město nenalezeno.</CommandEmpty>
                <CommandGroup>
                  <ScrollArea className="h-[300px]">
